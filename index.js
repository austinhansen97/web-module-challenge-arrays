...
function removeFlavorByName(array, flavor) {
  ...
  console.log(array);
  return array;
  // i want to get a flavor(as a string) to enter the funtion and then return the array it was in but now it is no longer there.
}
...
function filterByWord(array, string) {
  //make empty array so we can push our strings to it
